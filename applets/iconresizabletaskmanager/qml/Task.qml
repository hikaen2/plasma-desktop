...
import plasma.applet.org.kde.plasma.iconresizabletaskmanager as TaskManagerApplet
...
PlasmaCore.ToolTipArea {
    ...
    onSmartLauncherEnabledChanged: {
        if (smartLauncherEnabled && !smartLauncherItem) {
            const component = Qt.createComponent("plasma.applet.org.kde.plasma.iconresizabletaskmanager", "SmartLauncherItem");
